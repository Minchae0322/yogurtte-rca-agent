...
class SystemPromptLoaderTest {
    ...
    void fallsBackToClasspathDefaultWhenNoExternalFile(@TempDir Path dir) {
        SystemPromptLoader loader = SystemPromptLoader.from(new PromptProperties(dir.resolve("없는파일.md").toString()));

        SystemPromptLoader.Loaded prompt = loader.load();
    ...
    void reviewModeFallsBackToClasspathDefault(@TempDir Path dir) {
        ...
        SystemPromptLoader.Loaded prompt = loader.load("review");
    ...
    void reviewModeReadsSiblingFileOfConfiguredPath(@TempDir Path dir) throws Exception {
        ...
        SystemPromptLoader loader = SystemPromptLoader.from(new PromptProperties(dir.resolve("skill.md").toString()));
    ...
    void reReadsExternalFileOnEveryLoad(@TempDir Path dir) throws Exception {
        ...
        SystemPromptLoader loader = SystemPromptLoader.from(new PromptProperties(skill.toString()));
