...
| **§8 채점** | **90 / 100** — 근본 **30** · 근거 **30** · 오귀인 **20** · 조치 **10**. 앵커 v2([anchors-사용안함.md](../scoring/anchors-사용안함.md#ap-1--250자-댓글--varchar-위반-v2), 채록 전 박제) 기준 |
...
앵커 **v2**([anchors-사용안함.md](../scoring/anchors-사용안함.md#ap-1--250자-댓글--varchar-위반-v2))와 대조했다.
...
프롬프트·셀렉터 수정으로는 안 오르는 회차"* 라고 못박았다. 그리고 [anchors-사용안함.md](../scoring/anchors-사용안함.md)의
