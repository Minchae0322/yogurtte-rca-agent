...
| **5** | 08-05 02:39:03 | **자연어**(문안 동일) · 창 미지정 | 동일 | HTTP 500 (`Duplicate entry '163-178'`) | O · **100 (판정 0건)** | [round-5.md](round-5.md) |
| **6** | 08-12 01:35:08 | **자연어**(문안 동일) · 창 미지정 | 동일 · **AP-1·AP-2 동시 주입** | HTTP 500 (`Duplicate entry '166-179'`) | O · **100 (판정 1건)** · B-46이 논증의 축 | [round-6.md](round-6.md) |
