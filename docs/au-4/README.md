...
|---|---|---|---|---|---|---|
| 1 | 07-27 07:00 | 22분 51초 | **A (fallback 정상)** | 로그인 503 / 피드 200 유지·작성자 **익명 10명** — fallback이 버팀 | O | [round-1.md](round-1.md) |

회차 1 조사 결과: **에이전트가 앵커보다 정확했다.** 앵커는 "3s timeout"을 만점 요건으로
요구했으나 실측은 **23.5ms connection refused**였고, 에이전트는 "타임아웃이 아니라 TCP RST"로
정확히 구별했다. 평가 상세는 [AE-06](../findings/ae-06-rca-v0-au4-blind-eval.md).
